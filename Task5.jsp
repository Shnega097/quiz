...
<body>
    ...
    <form action="Task6.jsp" method="post">
        ...
        <p> Which one of the following is not a Java feature?</p>

        <input type="radio" name="answer4" value="Object-oriented">Object-oriented<br>

        <input type="radio" name="answer4" value="Use of pointers"> Use of pointers<br>

        <input type="radio" name="answer4" value="Portable">  Portable<br>

        <input type="radio" name="answer4" value="Dynamic and Extensible">Dynamic and Extensible<br>
