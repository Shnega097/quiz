...
<body>
    ...
    <form action="Task11.jsp" method="post">

        <p> Which of the following is a type of polymorphism in Java Programming?</p>

        <input type="radio" name="answer9" value="Multiple polymorphism">Multiple polymorphism <br>

        <input type="radio" name="answer9" value="Compile time polymorphism">Compile time polymorphism<br>

        <input type="radio" name="answer9" value="Multilevel polymorphism">Multilevel polymorphism<br>

        <input type="radio" name="answer9" value="Execution time polymorphism">Execution time polymorphism<br>
