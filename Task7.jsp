...
<body>
    ...
    <form action="Task8.jsp" method="post">

        <p> What is the extension of java code files?</p>

        <input type="radio" name="answer6" value=".js">.js<br>

        <input type="radio" name="answer6" value=".txt">.txt<br>

        <input type="radio" name="answer6" value=".class">.class<br>

        <input type="radio" name="answer6" value=".java">.java<br>
